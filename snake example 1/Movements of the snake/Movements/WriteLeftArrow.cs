    ...
    public class WriteLeftArrow : WriteDownArrow
    {
        ...
        public static void LeftArrow()
        {
            ...
            if (Console.KeyAvailable == true)
            {
                ...
                if (CKI.Key == ConsoleKey.DownArrow ^ CKI.Key == ConsoleKey.UpArrow ^ CKI.Key == ConsoleKey.RightArrow)
                {
                    _userBtnRight = CKI.Key;
                    CoordinateRecord.AllCoordintatesRecords(_x, _y, fullSnake, _i, 3, _snakeIndex);
                    _i = 0;
                    fullSnake = false;
                    leftX = 0;
                    if (zxc == false)
            ...
            {
                _userBtnRight = ConsoleKey.LeftArrow;
